...
if [ -f ~/.git-prompt.sh ]; then
	...
	#PROMPT_COMMAND='PS1_CMD1=$(__git_ps1 " (%s)")'; PS1='\e[0;32m[\u@\H: \w]\e[0m > ${PS1_CMD1}'
	PROMPT_COMMAND='PS1_CMD1=$(__git_ps1 " (%s)")'; PS1='\e[0;32m[\u@\H: \w]\e[0m \$ > ${PS1_CMD1} '
	# Source: https://robotmoon.com/bash-prompt-generator/
	#blue
	#PROMPT_COMMAND="PS1_CMD1=$(__git_ps1 " (%s)")";PS1="\[$(tput setaf 39)\]\u\[$(tput setaf 45)\]@\[$(tput setaf 51)\]\h: \[$(tput setaf 195)\]\w \[$(tput sgr0)\]$ ${PS1_CMD1} "
	PS1_CMD1='$(__git_ps1 "(%s)")'
	PS1="\[$(tput setaf 39)\]\u\[$(tput setaf 45)\]@\[$(tput setaf 51)\]\h: \[$(tput setaf 195)\]\w \[$(tput sgr0)\]$ ${PS1_CMD1} "
	#PROMPT_COMMAND='PS1_CMD1=$(__git_ps1 " (%s)")';PS1="\[\e[38;5;39m\]\u\[\e[38;5;45m\]@\[\e[38;5;51m\]\h \[\e[38;5;195m\]\w \[\033[0m\]$ ${PS1_CMD1} "
	#green
	#PS1="\[$(tput setaf 34)\]\u\[$(tput setaf 40)\]@\[$(tput setaf 46)\]\h \[$(tput setaf 154)\]\w \[$(tput sgr0)\]$ ${PS1_CMD1} "
	#PS1="\[\e[38;5;34m\]\u\[\e[38;5;40m\]@\[\e[38;5;46m\]\h \[\e[38;5;154m\]\w \[\033[0m\]$ ${PS1_CMD1} "
fi
